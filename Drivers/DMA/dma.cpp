...
namespace drivers::DMA
{
    ...
    void DMA::disable(const drivers::DMA::NUMBER_STREAM &numberStream) const noexcept {
    ...
    std::uint8_t DMA::getFlagFIFOcontrol(const drivers::DMA::NUMBER_STREAM &numberStream,
        ...
        std::uint32_t temp = readWriteRegister::read_register<std::uint32_t>(getAddress(numberStream,FCR));
