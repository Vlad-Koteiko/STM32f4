...
namespace drivers::spi
{
    SPI::SPI(drivers::clock::ClockControl curClock, ADDRESSES_SPI spi) : clock(curClock), baseAddress(spi){
        switch (spi) {
            case SPI1:
                clock.EnablePeripherals(drivers::clock::constants::SPI1_MODULE); break;
            case SPI2:
                clock.EnablePeripherals(drivers::clock::constants::SPI2_MODULE); break;
            case SPI3:
                clock.EnablePeripherals(drivers::clock::constants::SPI3_MODULE); break;
            case SPI4:
                clock.EnablePeripherals(drivers::clock::constants::SPI4_MODULE); break;
            case SPI5:
                clock.EnablePeripherals(drivers::clock::constants::SPI5_MODULE); break;
            case SPI6:
                clock.EnablePeripherals(drivers::clock::constants::SPI6_MODULE); break;
        }
    }
