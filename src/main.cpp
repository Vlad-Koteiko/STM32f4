...
//        gpio_A.PIN_init(gpio_A.PIN_0, gpio_A.INPUT);
        ...
        gpioD.InitPin(GPIO_D::PIN_12, GPIO_D::OUTPUT);
        gpioD.InitPin(GPIO_D::PIN_13, GPIO_D::OUTPUT);
        gpioD.InitPin(GPIO_D::PIN_14, GPIO_D::OUTPUT);
        gpioD.InitPin(GPIO_D::PIN_15, GPIO_D::OUTPUT);
...
//            clockControl.mDelay(500);
            ...
            gpioD.TogglePin(GPIO_D::PIN_12);
            clockControl.mDelay(500);
            gpioD.TogglePin(GPIO_D::PIN_13);
            clockControl.mDelay(500);
            gpioD.TogglePin(GPIO_D::PIN_14);
            clockControl.mDelay(500);
            gpioD.TogglePin(GPIO_D::PIN_15);
            clockControl.mDelay(500);
            //wathdog.Refresh();
        }
